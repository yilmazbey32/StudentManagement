...
public class LessonService {
    ...
    public ResponseMessage<LessonResponse> saveLesson(LessonRequest lessonRequest) {
        ...
        boolean lesssonExist = lessonRepository.existsLessonByLessonNameEqualsIgnoreCase(lessonName);
        if (lesssonExist) {
            throw new ConflictException(String.format(ErrorMessages.ALREADY_EXIST_ADVISOR_MESSAGE, lessonName));
        } else {
           return false;
        }
