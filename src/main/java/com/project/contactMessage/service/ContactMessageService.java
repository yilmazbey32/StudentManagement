...
public class ContactMessageService {
    ...
    public List<ContactMessage> searcByDateBetween(String beginDateString, String endDateString) {
        try {
    ...
    public List<ContactMessage> searchBetweenTimes(String startHour, String startMinute, String endHour, String endMinute) {
        try {
            ...
            return contactMessageRepository.findMessagesBetweenTimes(startH,startM,endM,endH);
